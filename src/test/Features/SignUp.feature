Feature: Create an Account
  ...
  Scenario: Successful Account Created with Valid Credentials
    ...
    And User enters FirstName as "Test" and LastName as "Admin" and Email as "admin018@yourstore.com" and Password as "Admin@12344" and ConfirmPassword as "Admin@12344"
